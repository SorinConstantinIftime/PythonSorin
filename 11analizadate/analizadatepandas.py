...
#
# df['Experienta'] = [2, 5, 1]
# df.set_index('Nume', inplace=True) #cheie primara 'Nume'
# # df_filtrat = df[df['Varsta'] > 25]
# df_filtrat = df[(df['Varsta'] > 22) & (df['Experienta'] >= 2)]
# print(df_filtrat)

# df.reset_index('Nume', inplace=True)
# print(df.loc['Bogdan'])
# print(df.iloc[1])
# print(df)
# nume = df['Nume'] #printeaza doar nume
# print(nume)
